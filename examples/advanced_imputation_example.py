...
import pandas as pd
import numpy as np
from automl.preprocessing.cleaners.advanced_imputation import AdvancedMissingValueHandler
...
def example_knn_imputation():
    ...
    print(f"  Categorical columns encoded: {len(summary['categorical_columns_encoded'])}")
...
def example_real_world_usage():
    ...
    data = pd.DataFrame({
        ...
        'employment': np.random.choice(['Employed', 'Self-Employed', 'Unemployed'], 200)
    })
