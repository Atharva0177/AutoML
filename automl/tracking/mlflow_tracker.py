...
class MLflowTracker:
    ...
    def __init__(
        ...
        logger.info(f"Initialized MLflowTracker (experiment: {experiment_name}, uri: {self.tracking_uri})")
    ...
    def start_run(
        ...
        try:
            ...
            logger.info(f"Started MLflow run: {run_name or 'unnamed'} (ID: {self.current_run_id})")
    ...
    def end_run(self, status: str = "FINISHED"):
        ...
        try:
            if self.current_run is not None:
                ...
                logger.info(f"Ended MLflow run (ID: {self.current_run_id}, status: {status})")
                self.current_run = None
                self.current_run_id = None
        except Exception as e:
