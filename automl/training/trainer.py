...
class Trainer:
    ...
    def __init__(
        ...
        self.log_to_mlflow = log_to_mlflow and MLFLOW_AVAILABLE and mlflow_tracker is not None
    ...
    def train(
        ...
        **fit_kwargs: Any
        ...
        try:
            ...
            if self.optimize_hyperparameters and X_val is not None and y_val is not None:
                ...
                logger.info(f"Hyperparameter optimization complete: {len(study.trials)} trials")
    ...
    def _log_to_mlflow(
        ...
        try:
            ...
            if 'optimization_trials' in results:
                self.mlflow_tracker.log_metric('optimization_trials', results['optimization_trials'])
                self.mlflow_tracker.log_metric('best_optimization_score', results.get('best_optimization_score', 0))
