...
class CrossValidator:
    ...
    def cross_validate(
        ...
        """
        logger.info(f"Starting {self.n_splits}-fold cross-validation for {model.name}")
    ...
    def _aggregate_fold_results(
        self, fold_metrics: List[Dict[str, Any]], model_type: str
    ) -> Dict[str, Any]:
        """
    ...
    def get_cv_summary(self, cv_results: Dict[str, Any], model_type: str) -> str:
        """
