...
class AutoML:
    ...
    def load_data(
        self, filepath: Union[str, Path], target_column: Optional[str] = None, **kwargs
    ) -> pd.DataFrame:
        """
    ...
    def get_data_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "missing_percentage": self.metadata.get(
                "quality.missing_values.percentage"
            ),
        }
