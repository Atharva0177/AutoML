...
class TestBaseModelFunctionality:
    ...
    @pytest.mark.parametrize('model_class,model_type', [
    ...
    def test_metadata(self, model_class, model_type, classification_data, regression_data):
        """Test metadata extraction."""
        data = classification_data if model_type == 'classification' else regression_data
        X, y = data
