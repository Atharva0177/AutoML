...
class TestDataLoaders:
    ...
    def test_create_dataloaders(self):
        ...
        train_loader, val_loader = create_dataloaders(
            X_train, y_train, X_val, y_val, task_type="classification", batch_size=16
        )
...
class TestMLPClassifier:
    ...
    def test_initialization(self):
        ...
        model = MLPClassifier(name="test_mlp", hidden_layers=[64, 32], max_epochs=10)
    ...
    def test_fit_predict(self):
        ...
        X, y = make_classification(
            n_samples=200, n_features=10, n_classes=3, n_informative=8, random_state=42
        )
    ...
    def test_predict_proba(self):
        ...
        model = MLPClassifier(
            hidden_layers=[32], max_epochs=10, use_gpu=False, random_state=42
        )
        model.fit(X_train, y_train, verbose=False)
...
class TestMLPRegressor:
    ...
    def test_initialization(self):
        ...
        model = MLPRegressor(
            name="test_mlp_reg", hidden_layers=[128, 64, 32], max_epochs=50
        )
    ...
    def test_prediction_accuracy(self):
        ...
        model = MLPRegressor(
            hidden_layers=[64, 32], max_epochs=50, use_gpu=False, random_state=42
        )
        model.fit(X_train, y_train, verbose=False)
...
class TestModelSavingLoading:
    ...
    def test_save_load_regressor(self, tmp_path):
        ...
        # Train model
        model = MLPRegressor(
            hidden_layers=[64, 32], max_epochs=15, use_gpu=False, random_state=42
        )
        model.fit(X, y, verbose=False)
