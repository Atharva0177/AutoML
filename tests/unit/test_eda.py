...
from automl.eda import StatisticalProfiler, ProblemDetector, CorrelationAnalyzer
...
class TestProblemDetector:
    ...
    def test_detect_multiclass_classification(self):
        ...
        assert problem_info["problem_type"] == ProblemType.MULTICLASS_CLASSIFICATION.value
